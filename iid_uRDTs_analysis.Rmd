...
`r descriptives$npos_any4` samples were positive by any of the tests. `r descriptives$npos_HRP2` samples were positive by HRP2 (`r descriptives$only_HRP2` samples were detected positive only by HRP2 and not by the other tests, Figure 2A), and the median concentration of HRP2 protein was `r descriptives$median_HRP2$median` pg/mL (95% CI: `r descriptives$median_HRP2$q25` - `r descriptives$median_HRP2$q75`). For qPCR, `r descriptives$npos_qPCR` samples were positives (`r descriptives$only_qPCR` only by qPCR) and the median parasite density was `r descriptives$median_qPCR$median` parasites/uL (95% CI: `r descriptives$median_qPCR$q25` - `r descriptives$median_qPCR$q75`). For RDTs, `r descriptives$npos_RDT` samples were positives (`r descriptives$only_RDT` only by RDT), and the median of HRP2 concentration and parasite density along RDT positive samples were `r descriptives$median_HRP2_RDT$median` pg/mL (95% CI: `r descriptives$median_HRP2_RDT$q25` - `r descriptives$median_HRP2_RDT$q75`) and `r descriptives$median_qPCR_RDT$median` parasites/uL (95% CI: `r descriptives$median_qPCR_RDT$q25` - `r descriptives$median_qPCR_RDT$q75`), respectively. Regarding uRDTs, `r descriptives$npos_uRDT` were positives (`r descriptives$only_uRDT` only by uRDTs), and the median of HRP2 concentration and parasite density along uRDT positive samples were `r descriptives$median_HRP2_uRDT$median` pg/mL (95% CI: `r descriptives$median_HRP2_uRDT$q25` - `r descriptives$median_HRP2_uRDT$q75`) and `r descriptives$median_qPCR_uRDT$median` parasites/uL (95% CI: `r descriptives$median_qPCR_uRDT$q25` - `r descriptives$median_qPCR_uRDT$q75`), respectively (Figures 3A and 3D show the distribution of positive samples by HRP2 concentration and parasite density, respectively). Regarding the `r descriptives$only_qPCR` that were detected only by qPCR, `r sum(descriptives$pos_qPCR_qualdiag[descriptives$pos_qPCR_qualdiag$qual_diag == "P. falciparum" | descriptives$pos_qPCR_qualdiag$qual_diag == "Pf Mixed infection",][["nSamples"]])` were P. falciparum positive by the qPCR qualitative test (one of them was a mixed infection with P. malariae), and one sample was P. malariae (Figure 2B).
...
and `r performance_qPCR_all$conf_table %>% filter(test == "uRDT", kind_result == "tp") %>% select(count) %>% unlist()`  out of the  `r descriptives$npos_qPCR` positive samples detected by qPCR test, respectively. Moreover, the proportion of positive detected samples did not increased as a function of the parasite density of the sample (Figure 3E), and the limit of detection of RDTs and uRDTs were `r lod.RDT.qpcr$lod$lod` and `r lod.uRDT.qpcr$lod$lod` respectively (Figure 3F). Thus, the overall sensitivity and specificity for RDTs were `r performance_qPCR_all$metrics %>% filter(test == "RDT", metric == "sens") %>% select(value)%>% round(digits = 2)` (95% CI: `r performance_qPCR_all$metrics %>% filter(test == "RDT", metric == "sens") %>% select(lower, upper) %>% round(digits = 2)%>% paste0(collapse= " - ")`) and `r performance_qPCR_all$metrics %>% filter(test == "RDT", metric == "spec") %>% select(value)%>% round(digits = 2)` (95% CI: `r performance_qPCR_all$metrics %>% filter(test == "RDT", metric == "spec") %>% select(lower, upper) %>% round(digits = 2)%>% paste0(collapse= " - ")`), and for uRDT they were `r performance_qPCR_all$metrics %>% filter(test == "uRDT", metric == "sens") %>% select(value)%>% round(digits = 2)`  (95% CI: `r performance_qPCR_all$metrics %>% filter(test == "uRDT", metric == "sens") %>% select(lower, upper) %>% round(digits = 2)%>% paste0(collapse= " - ")`) and `r performance_qPCR_all$metrics %>% filter(test == "uRDT", metric == "spec") %>% select(value)%>% round(digits = 2)`  (95% CI: `r performance_qPCR_all$metrics %>% filter(test == "uRDT", metric == "spec") %>% select(lower, upper) %>% round(digits = 2)%>% paste0(collapse= " - ")`), respectively. Restricting the analysis to samples with a parasitemia greater than 100 parasites/uL, the sensitivity and specificity for RDTs were `r performance_qPCR.100high$metrics %>% filter(test == "RDT", metric == "sens") %>% select(value)%>% round(digits = 2)%>% round(digits = 2)` (95% CI: `r performance_qPCR.100high$metrics %>% filter(test == "RDT", metric == "sens") %>% select(lower, upper) %>% round(digits = 2)%>% paste0(collapse= " - ")`) and `r performance_qPCR.100high$metrics %>% filter(test == "RDT", metric == "spec") %>% select(value)%>% round(digits = 2)` (95% CI: `r performance_qPCR.100high$metrics %>% filter(test == "RDT", metric == "spec") %>% select(lower, upper) %>% round(digits = 2)%>% paste0(collapse= " - ")`); and for uRDT, were `r performance_qPCR.100high$metrics %>% filter(test == "uRDT", metric == "sens") %>% select(value)%>% round(digits = 2)`  (95% CI: `r performance_qPCR.100high$metrics %>% filter(test == "uRDT", metric == "sens") %>% select(lower, upper) %>% round(digits = 2)%>% paste0(collapse= " - ")`) and `r performance_qPCR.100high$metrics %>% filter(test == "uRDT", metric == "spec") %>% select(value)%>% round(digits = 2)`  (95% CI: `r performance_qPCR.100high$metrics %>% filter(test == "uRDT", metric == "spec") %>% select(lower, upper) %>% round(digits = 2)%>% paste0(collapse= " - ")`), respectively. However, when from the set of all qPCR positive samples, the HRP2 negative samples (assuming HRP2 gene deletion of these samples) and samples with more than 1000 parasites/uL (low number of samples) were excluded, LOD for RDTs and uRDTs were `r lod.RDT.qpcr2$lod$lod` and `r lod.uRDT.qpcr2$lod$lod`, respectively (Figure 3H). Furthermore, the sensitivity for both tests also increased. Sensitivity for RDTs was `r performance_qPCR.2$metrics %>% filter(test == "RDT", metric == "sens") %>% select(value)%>% round(digits = 2)` (95% CI: `r performance_qPCR.2$metrics %>% filter(test == "RDT", metric == "sens") %>% select(lower, upper) %>% round(digits = 2)%>% paste0(collapse= " - ")`) and for uRDT it was `r performance_qPCR.2$metrics %>% filter(test == "uRDT", metric == "sens") %>% select(value)%>% round(digits = 2)` (95% CI: `r performance_qPCR.2$metrics %>% filter(test == "uRDT", metric == "sens") %>% select(lower, upper) %>% round(digits = 2)%>% paste0(collapse= " - ")`).
